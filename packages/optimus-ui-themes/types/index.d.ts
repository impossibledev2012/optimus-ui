 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@openng/optimus-ui-styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@openng/optimus-ui-styled` instead.
